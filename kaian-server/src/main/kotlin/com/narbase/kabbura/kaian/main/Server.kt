package com.narbase.kabbura.kaian.main


import com.narbase.kabbura.kaian.common.auth.setupAuthenticators
import com.narbase.kabbura.kaian.common.db.DatabaseConnector
import com.narbase.kabbura.kaian.common.db.migrations.Migrations
import com.narbase.kabbura.kaian.common.db.migrations.initializeUserMigrations
import com.narbase.kabbura.kaian.common.exceptions.handleExceptions
import com.narbase.kabbura.kaian.deployment.appConf
import com.narbase.kabbura.kaian.domain.admin.setupAdminRoutes
import com.narbase.kabbura.kaian.domain.client.setupClientRoutes
import com.narbase.kabbura.kaian.domain.user.setupUserRoutes
import com.narbase.kabbura.kaian.main.files.filesWithThumbnailsGenerator
import com.narbase.kabbura.kaian.main.properties.VersionProperties
import com.narbase.kabbura.kaian.main.provisioning.registerFirstAdmin
import io.ktor.http.*
...
object Server {
    ...
    private fun Application.appModule() {
        ...
        routing {
            ...
            static("/") {
                file("kaian-web.js", "web/kaian-web.js")
            }
