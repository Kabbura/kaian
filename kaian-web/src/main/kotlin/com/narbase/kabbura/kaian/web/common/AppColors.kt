package com.narbase.kabbura.kaian.web.common
...
object AppColors {
    ...
    val kaianColor = Color("4B71EC")
    val lightKaianColor = Color("89A1EE")
    val borderColorHex = "#cecece"
    val borderColor = Color("cecece")
    val borderDarkColor = Color("999")
    val focusInputBorderColor = Color("046bf6")

    val textKaianDarkColor = Color("#303A5B")

    val kaianDarkColor = Color("0098AC")
    val kaianVeryDarkColor = Color("405366")
