...
import com.narbase.kabbura.kaian.data.dto.roles.privilegesEnums
import com.narbase.kabbura.kaian.dto.models.roles.Privilege
import com.narbase.kabbura.kaian.web.common.AppColors
import com.narbase.kabbura.kaian.web.network.makeNotVisible
import com.narbase.kabbura.kaian.web.network.makeVisible
import com.narbase.kabbura.kaian.web.translations.display.displayName
import com.narbase.kabbura.kaian.web.translations.localized
import com.narbase.kabbura.kaian.web.utils.dialog.labeledTextInput
import com.narbase.kabbura.kaian.web.utils.horizontalFiller
import com.narbase.kabbura.kaian.web.utils.scrollable.scrollable
import com.narbase.kabbura.kaian.web.utils.table.headerCell
import com.narbase.kabbura.kaian.web.utils.table.listTable
import com.narbase.kabbura.kaian.web.utils.table.tableCell
import com.narbase.kabbura.kaian.web.utils.table.tableRow
import com.narbase.kabbura.kaian.web.utils.verticalFiller
import com.narbase.kabbura.kaian.web.utils.verticalSeparator
import com.narbase.kabbura.kaian.web.utils.views.*
import com.narbase.kabbura.kaian.web.utils.views.customViews.customCheckBox
    ...
    private fun LinearLayout.addItemButton() {
        textView {
            style {
                ...
                backgroundColor = AppColors.kaianColor
                borderRadius = 12.px
                pointerCursor()
                hover {
                    backgroundColor = AppColors.kaianDarkColor
                }
            }
