...
import com.narbase.kabbura.kaian.web.utils.eventbus.LifecycleSubscriber
...
import com.narbase.kabbura.kaian.web.utils.views.SideBar.Styles.mainTabTextStyle
import com.narbase.kabbura.kaian.web.utils.views.SideBar.Styles.selectedTabRuleSet
    ...
    private fun LinearLayout.addMenuItem(tab: SubTab<T>): View {
        return horizontalLayout {
            ...
            style {
                ...
                pointerCursor()
                hover {
                    color = AppColors.textKaianDarkColor
                }
            }
...
//            fontWeight = "bold"
        ...
        val selectedTabRuleSet by lazy {
            classRuleSet {
                ...
                color = AppColors.textKaianDarkColor
                borderStart = "8px solid ${AppColors.textKaianDarkColor}"
            }
        }
    }
