                        ...
                        val customCheckbox by lazy {
                            detached.verticalLayout {
                                style {
                                    ...
                                    border = "thin solid ${AppColors.kaianColor}"
                                }
                                mount(checkMark)
                                if (selectableItem.isSelected) {
